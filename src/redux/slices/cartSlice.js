...
const addDecimals = (num) => {
  return (Math.round(num * 100) / 100).toFixed(2) // 소수점 둘째 자리까지 반올림
}
...
export const { addToCart, removeFromCart, saveShippingAddress, ShippingAddress, savePaymentMethod, hideLoading } = cartSlice.actions
